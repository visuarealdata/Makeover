...
visuareal_logo = Image.open('./imgs/Asset-1.png')
...
lip_color = st.sidebar.color_picker('Pick the Lip Color', '#9C104F')

lip_color = ImageColor.getcolor(lip_color, "RGB")



colors = [lip_color, lip_color]
...
col1, col2 = st.columns(2)  # Create a grid of 2 columns
